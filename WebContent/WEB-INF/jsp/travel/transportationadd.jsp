...
<h2 class="text-center">Add new transportation</h2><br/><br/>
<form:form action="./transportationadd.htm" commandName="transportationForm" 
                 method="post">
...
<a href="<c:url value="/transportations.htm" />"><input type=button value="Back" class="btn btn-success"/></a>
</form:form>
