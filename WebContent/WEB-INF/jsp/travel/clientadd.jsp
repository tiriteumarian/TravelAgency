...
<h2 class="text-center">Add new client</h2><br/><br/>
<form:form action="./clientadd.htm" commandName="clientForm" 
                 method="post">
...
<a href="<c:url value="/clients.htm" />"><input type=button value="Back" class="btn btn-success"/></a>
</form:form>
