...
<h2 class="text-center">Add new accommodation</h2><br/><br/>
<form:form action="./accommodationadd.htm" commandName="accommodationForm" 
                 method="post">
...
<a href="<c:url value="/accommodations.htm" />"><input type=button value="Back" class="btn btn-success"/></a>
</form:form>
